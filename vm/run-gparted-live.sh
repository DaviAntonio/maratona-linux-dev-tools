...
readonly IMAGE_LOCATION="link-gparted-live-1.3.1-1-amd64.iso"
readonly DISK_LOCATION="ubuntu-22.04-initial.qcow2"
readonly VM_NAME="ubuntu-22.04-gparted-live"
...
-drive file='link-gparted-live-1.3.1-1-amd64.iso',index=0,media=disk \
-drive file='ubuntu-20.04-initial.qcow2',index=1,media=disk \
-boot menu=on \
-netdev user,id=net0 \
...
-vga qxl \
-monitor stdio \
-name "ubuntu-20.04-gparted-live"
