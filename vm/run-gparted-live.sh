...
echo "Booting machine '${VM_DEBIAN_LIVE_NAME}' with HDD and Gparted Live"
...
-drive file="${GPARTED_LIVE_IMAGE_LOCATION}",format=raw,if=none,media=cdrom,index=0,id=drive-cd1,readonly=on \
